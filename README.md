...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/r-data.table-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-data.table-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add r-data.table
# for installing globally
pixi global install r-data.table
```
...
It is possible to list all of the versions of `r-data.table` available on your platform:
...
```
pixi search r-data.table --channel conda-forge
```
